# US House: Mortgage, Rental-Gap, and Trust Strategy

*pass6 addendum, 2026-07-02. Exploration of three moves on the US house before relocating: (1) reduce the monthly mortgage payment, (2) mitigate a delay in renting it out, (3) put the house into a trust before you leave. **NOT legal/tax/mortgage advice** — the three interact, and several items carry real legal landmines (due-on-sale, occupancy representations), so confirm with a **mortgage lender/broker, a real-estate/estate attorney, and your cross-border CPA** before acting.*

---

## 0. The Numbers (so we're honest about what's movable)
...
## 1. Reduce the Monthly Mortgage Payment

**First question — *why* do you want it lower?** The answer flips the recommendation:

| Your goal | Best move | Cost |
|---|---|---|
| **Make rent comfortably cover the payment** (cash-flow while abroad) | Refinance 11-yr → **30-yr** term | Lower monthly, but far more lifetime interest |
| **Trim the payment AND earn a guaranteed 6.1%** (you have idle cash) | **$50k paydown + recast** (Option B) | −$521/mo, saves ~$18.8k interest — but locks up cash |
| **Minimize total interest** | **Do nothing** — keep the 6.1% / 11-yr | Highest monthly, lowest total cost |
...
1. **Refinance BEFORE you leave, while on US W-2 income.** Lenders verify income; qualifying from **India payroll / unpaid leave** is very hard and slow. This is the single most time-sensitive item in this whole document — **if you're going to refi at all, do it now.**
2. **Owner-occupancy vs occupancy fraud.** Best rates require an **owner-occupied** refi, and most carry a **12-month occupancy clause**. Refinancing as "primary residence" while planning to move out in 2–3 months can be **occupancy misrepresentation** — don't do it. Two honest paths:
   - Refi now *only if* your relocation genuinely isn't finalized/committed at closing (talk to the broker candidly), **or**
...
**The catch — liquidity, which matters a lot during this relocation:**
- $50k sunk into home equity is **illiquid**. You generally can't pull it back without a **HELOC or cash-out refi — both very hard to qualify for from India on non-US income.**
- You need liquidity for: a **3–6 mo PITI reserve**, a **USD buffer against rupee depreciation** (Finance §6), **two international moves**, school deposits, and parents' medical costs. Don't starve those to prepay.
- **Do NOT recast if you're going to refinance** — a refi re-amortizes anyway, so a prior recast is wasted.
...
### Revocable Living Trust (RLT) — RECOMMENDED
- **What it does for *you specifically*:** a **US-based successor/co-trustee** (spouse, sibling, trusted person) can **legally act on the property while you're in India** — sign documents, deal with the PM, handle an insurance claim or a sale — without you needing to be reachable in US business hours. It also **avoids probate** (and ancillary probate) if something happens to you while abroad, and provides **incapacity management**. For a family living 8,000 miles away, the management-continuity benefit is the real prize.
- **Due-on-sale: SAFE.** The **Garn-St. Germain Act (12 U.S.C. §1701j-3(d)(8))** exempts transferring your residence into an **inter vivos trust where you remain a beneficiary** from the lender's due-on-sale clause. The lender cannot call the loan for this. *(Do the transfer while it's still your residence, before it's a rental, to stay squarely inside the exemption; confirm with counsel.)*
- **Tax-neutral:** a grantor RLT is a **pass-through** — same mortgage-interest deduction, same Schedule E, same SSN/EIN, no gift tax, no change to basis. The **W-8ECI / §871(d)** nonresident-landlord election (Finance §4) still flows through you unchanged.
- **Cost:** ~$1,500–3,000 for a proper RLT + pour-over will + deed transfer via an estate attorney; **do it before you leave** (signing/notarizing a US deed and estate documents is far easier stateside than from India).
- **Housekeeping:** record the new deed (grantor → "[Your name], Trustee of the [Family] Trust"); **notify your insurer** so the landlord policy **names the trust**; keep the lender informed if you wish (optional — they can't call it).

### LLC — NOT recommended here
- **Due-on-sale is NOT protected.** Garn-St. Germain does **not** exempt transfers to an LLC — transferring a mortgaged property to an LLC **can trigger the due-on-sale clause** (lenders increasingly enforce this), forcing full repayment. Big, avoidable risk.
